...
public class ProjectileContoller2 : MonoBehaviour
{
    float speed;
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.tag == "Enemy")
        {
            PlayerStats2.playerStats.UpdateScore(500);
        }
        else if (other.tag == "enemyProjectile")
        {
            PlayerStats2.playerStats.UpdateScore(100);
        }
        else if (other.tag == "Boss")
        {
            PlayerStats2.playerStats.UpdateScore(5000);
        }
